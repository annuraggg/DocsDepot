const NoHouse = () => {
  return (
    <div className="flex items-center h-full justify-center opacity-60 flex-col gap-3 text-2xl">
      <svg
        fill="#000000"
        version="1.1"
        id="Capa_1"
        ...
        width="50px"
        height="50px"
        viewBox="-8.22 -8.22 427.20 427.20"
        transform="rotate(0)"
        stroke="#000000"
        stroke-width="0.00410758"
      >
